...
class DepthNet52(nn.Module):
    ...
    def forward(self, left_img, right_img, KRKiUV_T, KT_T):
        #t1 = time.time()
        ...
        # 拼接左图原图和代价体积特征
        encoder_input = torch.cat([left_img, cost_volume], dim=1)
